...
import com.example.fahee.myapplication.PersonModel.PersonModel;
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(Signup.this,"Authentication not Complete",Toast.LENGTH_SHORT).show();
                        }
        ...
        ref.putFile(fileData).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if(!task.isSuccessful()) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(Signup.this,"Url Not Generate", Toast.LENGTH_SHORT).show();
                }
            }
        });
